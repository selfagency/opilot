...
describe('truncateMessages', () => {
  ...
  it('keeps system messages without truncation when they fit', () => {
    ...
    const result = truncateMessages([system, user], 10_000);
