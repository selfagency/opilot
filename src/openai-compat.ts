...
interface OpenAICompatStreamErrorPayload {
  error?:
    | string
    | {
        message?: string;
 ...
 */
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: SSE frame parsing is intentionally centralized here.
