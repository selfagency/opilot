...
- fix: bump engines.vscode to ^1.120.0, fix Codacy globals in wdio.conf.js by @selfagency in https://github.com/selfagency/opilot/pull/142
...
_Source: changes from v1.8.0 to v1.8.1._

## [1.7.5] - 2026-06-03

**Full Changelog**: https://github.com/selfagency/opilot/compare/v1.7.4...v1.7.5

_Source: changes from v1.7.4 to v1.7.5._

## [1.7.4] - 2026-06-03

**Full Changelog**: https://github.com/selfagency/opilot/compare/v1.7.3...v1.7.4

_Source: changes from v1.7.3 to v1.7.4._
...
- fix: eagerly register sidebar providers before async activation by @selfagency in https://github.com/selfagency/opilot/pull/114

**Full Changelog**: https://github.com/selfagency/opilot/compare/v1.7.1...v1.7.2
...
- fix: activate sidebar views on install by @selfagency in https://github.com/selfagency/opilot/pull/113

**Full Changelog**: https://github.com/selfagency/opilot/compare/v1.7.0...v1.7.1
